...
def _create(name, pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    ...
    from utilities.downloads import attempt_download
    from utilities.general import LOGGER, check_requirements, intersect_dicts, logging
...
if __name__ == '__main__':
    ...
    from utilities.general import cv2, print_args
