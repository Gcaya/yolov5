...
from utilities.general import LOGGER, colorstr, cv2
from utilities.loggers.clearml.clearml_utils import ClearmlLogger
from utilities.loggers.wandb.wandb_utils import WandbLogger
from utilities.plots import plot_images, plot_labels, plot_results
...
try:
    if RANK not in [0, -1]:
        ...
        from utilities.loggers.comet import CometLogger
